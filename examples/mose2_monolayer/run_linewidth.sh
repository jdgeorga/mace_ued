...
multi_rank mlip-linewidth-scatter-gpu --phono3py-yaml "$P3" --fc2-forces "$F23" --fc3-forces "$F3" --mesh 36 36 1 --temperature 50 --batch-size 1 --fallback-lang NONE --max-w-gb 8 --force-recompute-gamma-detail --cache-dir "$GAMMA_CACHE" --fc-cache-dir "$FC_CACHE" --output "$W_OUT"
