...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=["mlip", "dfpt"],
        default="mlip",
        help="Source of the harmonic fc2: MLIP-derived (produce_fc2) or a precomputed DFPT fc2.npy.",
    )
    parser.add_argument("--dfpt-fc2", default=None, help="Path to a DFPT fc2.npy (required when --fc2-source dfpt).")
...
def main() -> None:
    ...
    args = parse_args()
    if args.fc2_source == "dfpt" and args.dfpt_fc2 is None:
        raise ValueError("--dfpt-fc2 is required when --fc2-source dfpt.")
    ...
    set_phono3py_forces_with_mesh_fc_cache(
        ...
        dfpt_fc2=args.dfpt_fc2 if args.fc2_source == "dfpt" else None,
    )
